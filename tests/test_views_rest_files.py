...
def test_files_post_oauth2(app, db, deposit, files, users,
                           write_token_user_1):
...
def test_files_put_oauth2(app, db, deposit, files, users,
                          write_token_user_1):
...
def test_file_put_oauth2(app, db, deposit, files, users,
                         write_token_user_1):
